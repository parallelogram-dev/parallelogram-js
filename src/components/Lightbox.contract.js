...
Each link's \`href\` is the full-size image, so without JavaScript the links still open the images.`,
  ...
  attributes: [
    ...
    {
      name: 'data-lightbox-viewer-label',
      type: 'string',
      default: 'Image viewer',
      option: 'viewerLabel',
      description: 'The accessible name of the viewer',
    },
    {
      name: 'data-lightbox-close-label',
      type: 'string',
      default: 'Close',
      option: 'closeLabel',
    ...
    {
      name: 'data-lightbox-prev-label',
      type: 'string',
      default: 'Previous image',
      option: 'prevLabel',
      description: 'The accessible name of the previous button',
    },
    {
      name: 'data-lightbox-next-label',
      type: 'string',
      default: 'Next image',
      option: 'nextLabel',
      description: 'The accessible name of the next button',
    },
    {
      name: 'data-lightbox-load-error',
      type: 'string',
      default: "{image} couldn't be loaded",
      option: 'loadError',
      description:
        "Shown in place of an image that fails to load, with {image} for the thumbnail's alt text",
    },
    {
      name: 'data-lightbox-load-error-untitled',
      type: 'string',
      default: "The image couldn't be loaded",
      option: 'loadErrorUntitled',
      description: 'The same message for an image whose thumbnail has no alt text',
    },
