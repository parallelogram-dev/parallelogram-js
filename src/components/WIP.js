...
export class DataTable extends BaseComponent {
    ...
    _getConfiguration(element) {
        return {
            ...
            paginate: parseInt(this._getDataAttr(element, 'datatable-paginate', DataTable.defaults.paginate)) || false,
            pageSize: parseInt(this._getDataAttr(element, 'datatable-page-size', DataTable.defaults.pageSize)),
            searchDelay: parseInt(this._getDataAttr(element, 'datatable-search-delay', DataTable.defaults.searchDelay))
        };
    }
...
export class FormValidator extends BaseComponent {
    ...
    _getConfiguration(element) {
        return {
            validateOnInput: this._getDataAttr(element, 'validate-on-input', FormValidator.defaults.validateOnInput),
            validateOnBlur: this._getDataAttr(element, 'validate-on-blur', FormValidator.defaults.validateOnBlur),
            showErrorsImmediately: this._getDataAttr(element, 'show-errors-immediately', FormValidator.defaults.showErrorsImmediately),
            debounceMs: parseInt(this._getDataAttr(element, 'validate-debounce', FormValidator.defaults.debounceMs))
        };
    }
...
export class CopyToClipboard extends BaseComponent {
    ...
    _getConfiguration(element) {
        return {
            successMessage: this._getDataAttr(element, 'copy-success-message', CopyToClipboard.defaults.successMessage),
            errorMessage: this._getDataAttr(element, 'copy-error-message', CopyToClipboard.defaults.errorMessage),
            successDuration: parseInt(this._getDataAttr(element, 'copy-success-duration', CopyToClipboard.defaults.successDuration)),
            successClass: this._getDataAttr(element, 'copy-success-class', CopyToClipboard.defaults.successClass),
            errorClass: this._getDataAttr(element, 'copy-error-class', CopyToClipboard.defaults.errorClass)
        };
    }
