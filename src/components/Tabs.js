...
export class Tabs extends BaseComponent {
    ...
    _init(element) {
        ...
        if (!tabsList || !tabsContainer) {
            this.logger?.warn('Tabs: Missing required elements (data-tabs-list or data-tabs-panels)', element);
            return state;
        }
        ...
        const keyboardNav = this._getDataAttr(element, 'tabs-keyboard', Tabs.defaults.keyboardNavigation);
