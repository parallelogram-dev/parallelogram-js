...
export default class Toggle extends BaseComponent {
    ...
    _init(element) {
        ...
        const manual = target.hasAttribute('data-toggle-manual') ||
        ...
        const animateToggle = this._getDataAttr(element, 'toggle-animate', Toggle.defaults.animateToggle);
    ...
    _updateElementStates(element, state, isOpen) {
        ...
        const relatedTriggers = document.querySelectorAll(`[data-toggle-target="${state.targetSelector}"]`);
