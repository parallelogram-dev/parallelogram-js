...
export default class Carousel extends BaseComponent {
    ...
    _init(element) {
        ...
        const autoplayDelay = this._getDataAttr(element, 'carousel-autoplay-delay', Carousel.defaults.autoplayDelay);
        ...
        const showArrows = this._getDataAttr(element, 'carousel-show-arrows', Carousel.defaults.showArrows);
        const pauseOnHover = this._getDataAttr(element, 'carousel-pause-on-hover', Carousel.defaults.pauseOnHover);
        const keyboardNavigation = this._getDataAttr(element, 'carousel-keyboard', Carousel.defaults.keyboardNavigation);
