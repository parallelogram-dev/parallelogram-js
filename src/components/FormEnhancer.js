...
export class FormEnhancer extends BaseComponent {
    ...
    _getConfiguration(element) {
        return {
            validateOnInput: this._getDataAttr(element, 'validate-on-input', FormEnhancer.defaults.validateOnInput),
            validateOnBlur: this._getDataAttr(element, 'validate-on-blur', FormEnhancer.defaults.validateOnBlur),
            showErrorsImmediately: this._getDataAttr(element, 'show-errors-immediately', FormEnhancer.defaults.showErrorsImmediately),
            debounceMs: parseInt(this._getDataAttr(element, 'validate-debounce', FormEnhancer.defaults.debounceMs))
        };
    }
