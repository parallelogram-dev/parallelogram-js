...
export default {
  ...
  description: `Each tracker is a \`<script type="application/json">\` block that is never executed. DeferTracker boots the named adapter on the first click, key press or touch, or once the page has loaded and been idle for five seconds, which keeps tracker cost out of page load and lab tests such as Lighthouse.
