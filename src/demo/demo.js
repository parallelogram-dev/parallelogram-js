...
app.components
  .add('p-modal', () => import(/* webpackChunkName: "p-modal" */ '../../src/components/PModal.js'))
  .add(
    'p-toasts',
  ...
  .add('[data-tabs]', () => import(/* webpackChunkName: "tabs" */ '../../src/components/Tabs.js'))
  .add(
    '[data-videoplay]',
  ...
  .add('[data-demo="home"]', () => import(/* webpackChunkName: "demo-home" */ './DemoHome.js'))
  .add('[data-demo="media"]', () => import(/* webpackChunkName: "demo-media" */ './DemoMedia.js'))
  .add(
    '[data-demo="performance"]',
    () => import(/* webpackChunkName: "demo-performance" */ './DemoPerformance.js')
  )
  .add(
    '[data-demo="ui-components"]',
