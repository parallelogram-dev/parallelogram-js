...
export const TOKEN_GROUPS = [
  {
    ...
    note: 'The palette is compiled from Sass variables, so it can’t change live yet. The token refactor exposes it as custom properties that every surface uses.',
    tokens: [],
  },
  {
    id: 'surfaces',
