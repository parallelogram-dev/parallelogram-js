...
| `npm run test:browser:local` | Runs the browser tests in the Chrome already installed, with no Playwright download; set `CHROME_PATH` if it isn't in the usual place |
