...
var css_248z$1 = ":root{--form-control-padding-y:0.25em;--form-control-padding-x:0.75em;--form-control-padding-y-sm:0.125em;--form-control-padding-x-sm:0.5em;--form-control-padding-y-lg:0.5em;--form-control-padding-x-lg:1.25em;--form-control-border-width:1px;--form-control-border-color:rgba(0,0,0,.1);--form-control-border-radius:0.5em;--form-control-border-radius-sm:0.25em;--form-control-border-radius-lg:0.75em;--form-control-bg:#fff;--form-control-color:currentColor;--form-control-placeholder-color:rgba(0,0,0,.5);--form-control-focus-ring-width:2px;--form-control-focus-ring-color:#3b82f6;--form-control-focus-border-color:#3b82f6;--form-control-hover-border-color:#d4d4d4;--form-control-disabled-opacity:0.3;--form-control-disabled-bg:#f5f5f5;--form-control-font-size:0.875em;--form-control-font-size-sm:0.75em;--form-control-font-size-lg:1em;--form-control-font-family:inherit;--button-padding-y:0.25em;--button-padding-x:0.75em;--button-padding-y-sm:0.125em;--button-padding-x-sm:0.5em;--button-padding-y-lg:0.5em;--button-padding-x-lg:1.25em;--button-font-size:0.875em;--button-font-size-sm:0.75em;--button-font-size-lg:1em;--button-font-weight:600;--button-border-width:1px;--button-border-radius:0.5em;--button-border-radius-sm:0.25em;--button-border-radius-lg:0.75em;--button-min-height:2.5em;--button-min-height-sm:2em;--button-min-height-lg:3em;--button-primary-bg:#3b82f6;--button-primary-color:#fff;--button-primary-border:#3b82f6;--button-primary-hover-bg:#2563eb;--button-primary-hover-border:#2563eb;--button-secondary-bg:transparent;--button-secondary-color:currentColor;--button-secondary-border:#d4d4d4;--button-secondary-hover-bg:#f5f5f5;--button-secondary-hover-border:#d4d4d4;--button-danger-bg:#ef4444;--button-danger-color:#fff;--button-danger-border:#ef4444;--button-danger-hover-bg:#dc2626;--button-danger-hover-border:#dc2626;--button-ghost-bg:transparent;--button-ghost-color:currentColor;--button-ghost-border:currentColor;--button-ghost-hover-bg:rgba(0,0,0,.05);--panel-bg:#fff;--panel-border-width:1px;--panel-border-color:rgba(0,0,0,.1);--panel-border-radius:0.75em;--panel-padding:0.75em;--panel-shadow:0 4px 6px rgba(0,0,0,.12);--panel-padding-sm:0.5em;--panel-padding-lg:1.25em;--panel-border-radius-sm:0.5em;--panel-border-radius-lg:0.75em;--panel-header-padding:0.5em 0.75em;--panel-header-border:1px solid rgba(0,0,0,.1);--panel-footer-padding:0.5em 0.75em;--panel-footer-border:1px solid rgba(0,0,0,.1);--modal-shadow:0 1.25em 3em rgba(0,0,0,.5);--modal-backdrop-bg:rgba(0,0,0,.5)}@media (prefers-color-scheme:dark){:root{--form-control-bg:#171717;--form-control-color:#fff;--form-control-border-color:#525252;--form-control-placeholder-color:hsla(0,0%,100%,.5);--button-secondary-hover-bg:#525252;--panel-bg:#171717;--panel-border-color:#525252}}:host{border:2px solid #000;display:block;font-family:inherit;padding:.25em;position:relative}.uploader__files{display:grid;gap:.25em;margin-bottom:.25em}.uploader__selector{background:var(--panel-bg);background:#f5f5f5;border:var(--panel-border-width) solid var(--panel-border-color);border-color:#d4d4d4;border-radius:var(--panel-border-radius);border-width:2px;box-shadow:var(--panel-shadow);cursor:pointer;padding:2em;text-align:center}@media (prefers-reduced-motion:no-preference){.uploader__selector{transition:all .15s ease-in-out}}@media (hover:hover){.uploader__selector:hover{background:#f5f5f5;border-color:#525252}}.uploader__selector.dragover{background:rgba(59,130,246,.05);border-color:#3b82f6}.uploader__fileinput{display:none}.uploader__label{cursor:pointer;font-size:1em}::slotted(p-uploader-file){display:block}::slotted(p-uploader-fields){display:none}";

var css_248z = "*,:after,:before{box-sizing:border-box}:host{background:#fff;border:2px solid #000;display:block;font-family:inherit;padding:.375rem;position:relative;transition:border-color .15s ease-out,background-color .15s ease-out}:host([dragging]){opacity:.5;transition:none}:host([drag-over]){background:rgba(0,0,0,.05);border-color:#3b82f6;transform:translateY(-4px)}:host([draggable=true]){cursor:grab;user-select:none;-webkit-user-select:none}:host([draggable=true]:active){cursor:grabbing}button,input,textarea{font-family:inherit}.uploader__overlay{align-items:center;background:hsla(0,0%,100%,.95);display:flex;inset:0;justify-content:center;opacity:0;padding:0 .375rem 0 6.75rem;pointer-events:none;position:absolute;transition:opacity .3s cubic-bezier(.5,0,0,1);z-index:10}.uploader__overlay--show{opacity:1;pointer-events:auto}.uploader__progress{height:.5rem;width:100%}.uploader__container{display:flex;gap:.375rem;position:relative}.uploader__preview{flex-shrink:0;height:6rem;pointer-events:none;user-select:none;width:6rem}.uploader__preview img{height:100%;object-fit:cover;width:100%}.uploader__content{flex:1;min-width:0;overflow:hidden;position:relative}.uploader__content,.uploader__panel{display:flex;flex-direction:column;height:6rem}.uploader__panel{background:#fff;left:0;pointer-events:auto;position:absolute;right:0;top:0;transform:translateY(-100%);transition:transform .3s cubic-bezier(.5,0,0,1);will-change:transform}.uploader__panel--show{transform:translateY(0)}.uploader__panel[data-panel=info]{transform:translateY(100%)}.uploader__panel[data-panel=info].uploader__panel--activated{transform:translateY(-100%)}.uploader__panel[data-panel=info].uploader__panel--show{transform:translateY(0)}.uploader__panel[data-panel=delete],.uploader__panel[data-panel^=edit-]{transform:translateY(100%)}.uploader__panel[data-panel=delete].uploader__panel--show,.uploader__panel[data-panel^=edit-].uploader__panel--show{transform:translateY(0)}.uploader__alert,.uploader__body{align-items:center;display:flex;flex:1;flex-direction:row;min-height:6rem;position:relative}.uploader__alert{justify-content:space-between}.uploader__fields{display:flex;flex-direction:column}.uploader__filename,.uploader__heading{align-items:center;display:flex;font-size:.75rem;font-weight:600;height:1.125rem;line-height:1.125rem;margin:0 0 .5rem;padding-right:2rem}.uploader__filename{font-family:monospace}.uploader__field{align-items:center;display:flex;gap:.375rem;height:1.25rem;justify-content:flex-start;margin:0;padding-bottom:.1875rem;padding-top:.1875rem}.uploader__delete-icon{background-color:#fff;background-image:url(\"data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='24' height='24'%3E%3Cpath fill='none' d='M0 0h24v24H0V0z'/%3E%3Cpath fill='red' d='M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zm2.46-7.12 1.41-1.41L12 12.59l2.12-2.12 1.41 1.41L13.41 14l2.12 2.12-1.41 1.41L12 15.41l-2.12 2.12-1.41-1.41L10.59 14l-2.13-2.12zM15.5 4l-1-1h-5l-1 1H5v2h14V4z'/%3E%3Cpath fill='none' d='M0 0h24v24H0z'/%3E%3C/svg%3E\");background-position:50%;background-repeat:no-repeat;background-size:contain;border:none;cursor:pointer;height:1.25rem;opacity:.6;padding:0;pointer-events:auto;position:absolute;right:0;top:0;transition:opacity .15s;width:1.25rem}.uploader__delete-icon:hover{opacity:1}.uploader__actions{display:flex;gap:.375rem;justify-content:flex-end;padding-left:.375rem}.uploader__btn{background:#fff;border:1px solid #d4d4d4;cursor:pointer;flex-shrink:0;font-size:.75rem;padding:.375rem .75rem;pointer-events:auto;transition:all .15s}.uploader__btn:hover{background:#f5f5f5}.uploader__btn--secondary{background:transparent;border-color:currentColor}.uploader__btn--delete{border-color:#dc2626;color:#dc2626}.uploader__btn--delete:hover{background:#fee2e2}.uploader__btn--primary{background:#3b82f6;border-color:#3b82f6;color:#fff}.uploader__btn--primary:hover{background:#2563eb}.uploader__input,.uploader__textarea{border:1px solid #d4d4d4;flex:1 0 auto;font-family:inherit;font-size:.75rem;height:100%;margin:0;outline:0 none;padding:.375rem;pointer-events:auto}.uploader__textarea{min-height:60px;resize:vertical}.field__label{flex:0 0 4rem;font-weight:600}.field__label,.field__value{font-size:.75rem;opacity:rgba(0,0,0,.5)}.field__value{flex:0 1 auto;height:1.25rem;line-height:1.25rem;overflow:hidden;text-overflow:ellipsis;word-break:break-word}.field__value--editable{cursor:pointer}.field__value--editable:hover{opacity:1;text-decoration:underline}.field__edit{background-color:#fff;background-image:url(\"data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='24' height='24'%3E%3Cpath d='M3 17.25V21h3.75L17.81 9.94l-3.75-3.75zM20.71 7.04a.996.996 0 0 0 0-1.41l-2.34-2.34a.996.996 0 0 0-1.41 0l-1.83 1.83 3.75 3.75z'/%3E%3Cpath fill='none' d='M0 0h24v24H0z'/%3E%3C/svg%3E\");background-position:50%;background-repeat:no-repeat;background-size:contain;border:none;cursor:pointer;flex-shrink:0;height:1.25rem;opacity:.6;padding:0;pointer-events:auto;transition:opacity .15s;width:1.25rem}.field__edit:hover{opacity:1}.error-message{background:#fee2e2;color:#dc2626;font-size:.75rem;padding:.5rem}slot{display:none}";
