 ...
 * @returns {boolean}
 */
function isMountedState(stateValue) {
 ...
 * @returns {boolean}
 */
function isErrorState(stateValue) {
 ...
 * @returns {boolean}
 */
function isInitializingState(stateValue) {
 ...
 * @returns {string}
 */
function getInitialState(currentValue) {
...
export { ComponentStates, ExtendedStates, ComponentStates as default, getInitialState, isErrorState, isInitializingState, isMountedState };
